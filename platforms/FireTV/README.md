...
* Enter the url of either the [hosted version](https://ctv.truex.com/web/ref-app-IMA/master/index.html), or your locally running version (e.g. http://192.168.1.72:8080).
...
* `npm run build-firetv` to refer to the standard [hosted version](https://ctv.truex.com/web/ref-app-IMA/master/index.html).
